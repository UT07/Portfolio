...
const DJHero = () => {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      {/* Neon orbits */}
      <motion.div
        className="absolute -top-40 -left-32 w-[520px] h-[520px] rounded-full border border-fuchsia-500/30 blur-[1px]"
        style={{ boxShadow: '0 0 80px rgba(217,70,239,0.55)' }}
        animate={{ rotate: 360, scale: [1, 1.06, 1], opacity: [0.25, 0.5, 0.25] }}
        transition={{ duration: 18, repeat: Infinity, ease: 'linear' }}
      />
      <motion.div
        className="absolute -bottom-48 -right-40 w-[620px] h-[620px] rounded-full border border-fuchsia-500/20 blur-[2px]"
        style={{ boxShadow: '0 0 90px rgba(217,70,239,0.45)' }}
      ...
      <motion.div
        ...
        style={{
          background: 'conic-gradient(from 90deg, rgba(217,70,239,0.0), rgba(217,70,239,0.5), rgba(217,70,239,0.0) 60%)'
        }}
        animate={{ rotate: 360 }}
